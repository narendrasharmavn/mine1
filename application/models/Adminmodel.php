...
class Adminmodel extends CI_Model {
    ...
    public function getVendorCommissionReportAll($fromdate,$todate){
     ...
     public function  getVendorOutStandingTransactionsOnVendorId($vendorid){
        ...
        return $this->db->query("select t.*,v.vendorname,SUM(t.amountrecieved)-SUM(t.amountpaid) AS outstanding from tbltransactions t INNER JOIN tblvendors v ON t.vendorid=v.vendorid WHERE t.vendorid='$vendorid' ORDER BY t.tid desc");
