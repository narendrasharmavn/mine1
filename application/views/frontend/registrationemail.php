<!doctype html>
			...
			<tr>
			<td colspan="2">Username : <strong><a href="#" style="text-decoration:none;" target="_blank"><?php echo $email; ?></a></strong></td>
			</tr>
			<tr>
			<td colspan="2">&nbsp;</td>
			</tr>
			...
			<tr>
			<td colspan="2" style="font-size:16px"><a href="http://book4holiday.com" style="font-weight:bold;text-decoration:underline;color:#49ba8e" target="_blank" data-saferedirecturl="#">www.book4holiday.com</a>
			</td>
			</tr>
			<tr>
			<td colspan="2">&nbsp;</td>
