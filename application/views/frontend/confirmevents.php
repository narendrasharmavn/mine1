...
<table class="table table-bordered" style="font-size:12px;line-height: 1.5em;background-color: transparent;">
  ...
  <tr><td width="150">Child Tickets </td><td class="tdrt"><i class="fa fa-inr"></i><?php echo  $childpriceperticket; ?></td></tr>
    ...
    <td class="tdrt">
    <i class="fa fa-inr"></i><?php echo $ticketcost;  ?>
  ...
  <tr>
    ...
    <td class="tdrt">
      <i class="fa fa-inr"></i> <?php echo $this->session->userdata('internetcharges');  ?>
    </td>
  ...
  <tr>
    ...
    <td class="tdrt">
      <i class="fa fa-inr"></i> <?php echo $taxes; ?>
    </td>
   ...
   echo date("d-m-Y", strtotime($this->session->userdata('dateofvisit')));  ?>
    ...
    <td class="tdrt">
      <i class="fa fa-inr"></i> <?php echo $this->session->userdata('totalcost');  ?>
    </td></strong>
  </tr>
</table>
                    </div>
...
<div id="myModal" class="modal fade">
  <div class="modal-dialog">
    <div class="modal-content">
	  ...
	  <center>
        <button type="button" class="btn btn-primary cancel-booking">Ok</button>
        ...
        submitHandler: function(form) {
              ...
              if (session_check=="yes") {
                ...
                //ajax submit
                    ...
                    $.ajax({
                    type: "POST",
                    url: '<?php echo site_url("frontend/nosessionhandlerOTPCheckEvents")?>',
                    data: {
                        name:name,
                        mobile:mobile,
                        email:email
