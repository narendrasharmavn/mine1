                        ...
                        $query = $this->db->query("SELECT * from tblcustomers WHERE username='".$this->session->userdata('holidayEmail')."'");
                            ...
                            <form action="<?php echo base_url().'merchant/';  ?>submit.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="udf4" class=" form-control" placeholder="Name" value="<?php echo $eventsResults->eventname; ?>" readonly>
                                    <span class="text-danger"><?php echo form_error('name'); ?></span>
                                </div>
                                
                                <div class="form-group">
                                    <label>Package Name</label>
                                    <input type="email" name="udf1" class="form-control" placeholder="Email" value="<?php echo $eventsResults->packagename; ?>" readonly>
