 ...
 <input type="hidden" name="resortid" value="<?php echo $resortid;   ?>">
        ...
        <div id="overlay" class="over"><i class="icon-spin3 animate-spin"></i></div>
                  ...
                  <img src="<?php echo base_url();?>assets/resortimages/<?php echo $resortResults->bannerimage ;?>" class="img-responsive" style="width:100%;height:370px;">
...
<!--map ends from here-->
  ...
  <div class="col-md-4">
                ...
                <aside class="col-md-12 aside-panel" id="sidebar">
                            ...
                            <div class="box_style_1 over2" style="display:none;">
...
function update_tour_price() {
    ...
    var total_calculated_cost = 0;
    total_calculated_cost = (+price + +calculatedservicetax + +calculatedinternetcharges + +calculatedswachhbharath + +calculatedkkcess);
 ...
 if ($('#datepickerj').val() == "") {
    ...
    $('#book-selection-error').html('Please book atleast one ticket.');
        ...
        success: function(res) {
                ...
                if (res.trim()=="true") {
                    window.location.href="<?php echo site_url().'confirm-booking-resortss'; ?>";
