...
<script>
        ...
        function loadMap()
        {
            ...
            <?php foreach($getdata->result() as $k) { //you could replace this with your while loop query ?>
                addMarker(<?php echo $k->latitude; ?>, <?php echo $k->longitude; ?>, '<?php echo $k->resortname; ?>');
            <?php } ?>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-6">
                        <div class="styled-select-filters">
                            <select name="sort_date" id="sort_date" data-base-url="" onchange="showEvents()">
                                <option value="" selected="">Sort by Date</option>
                                <option value="today">Today</option>
                                <option value="tomorrow">Tomorrow</option>
                                <option value="tweekend">This Weekend</option>
                                <option value="nweekend">Next Weekend</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-6">
                        <div class="styled-select-filters">
                            <select name="sort_price" id="sort_price" data-base-url="" onchange="">
    ...
    <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-4">
            ...
            -->
                ...
                <a href="<?php echo site_url().'/frontend/showResortDetails/'.$k->resortid;   ?>">
                    ...
                    <img width="330" height="220" src="<?php echo base_url().'assets/resortimages/'.$k->photoname;  ?>" class="attachment-330x220 wp-post-image" alt="tour_box_1">                   <div class="short_info"><i class="icon_set_1_icon-4"></i><?php  echo $k->resortname;   ?></div>                </a>
            </div>
        </div>
        <div class="clearfix visible-xs-block"></div>
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="tour_list_desc">
                <!--<div class="rating"><i class="icon-smile"></i><i class="icon-smile"></i><i class="icon-smile"></i><i class="icon-smile"></i><i class="icon-smile"></i><small>(0)</small>
                </div>
                -->
        ...
        <div class="col-lg-2 col-md-2 col-sm-2">
            <div class="price_list">
                <div>
                   <span><sup>Rs.</sup><?php echo $row->minprice; ?></span><small>*Per person</small>
                    <p><a href="<?php echo site_url().'/frontend/showResortDetails/'.$k->resortid;   ?>" class="btn_1">Details</a></p>
                </div>
            </div>
        </div>
    </div>
