                        ...
                        <input type="hidden" name="amount" class=" form-control" placeholder="" value="<?php echo $this->session->userdata('total'); ?>" readonly>
                            ...
                            <div class="form-group">
                              ...
                              if ($this->session->userdata('holidayEmail')) {
                                 ...
                                 echo '<button type="button" id="cancel" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Cancel</button>';
                              }else{
                                echo '<button type="submit" id="pay" class="btn btn-primary">Pay</button>
								                 <button type="button" id="cancel" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Cancel</button>';
...
<table class="table table-bordered" style="font-size:12px;line-height: 1.5em;background-color: transparent;">
  ...
  <tr><td width="150">Taxes </td><td class="tdrt"><i class="fa fa-inr"></i><?php echo  $taxes;  ?></td></tr>
   ...
   echo date("d-m-Y", strtotime($this->session->userdata('dateofvisit')));  ?></td></tr>
	<tr style="font-weight: bold;font-size: 20px;"><strong><td width="150">Total</td><td class="tdrt"><i class="fa fa-inr"></i> <?php echo $this->session->userdata('total');  ?></td></strong></tr>
</table>
                    </div>
                </div>
            </div>
...
<center><h3>        Do you really want to cancel the booking?</h3></center>
      ...
      <div class="modal-footer"><center>
        ...
        <button type="button" class="btn btn-warning cancel-booking">OK</button></center>
      </div>
    </div>
  </div>
</div>
