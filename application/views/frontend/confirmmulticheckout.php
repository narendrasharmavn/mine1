                ...
                <div class="col-md-12 col-xs-12">
                    <div class="col-md-8 col-xs-12">
                        ...
                        <input type="hidden" name="amount" class=" form-control" placeholder="" value="<?php echo round($this->session->userdata('total'),0); ?>" readonly>
                                    ...
                                    <INPUT TYPE="hidden" NAME="ru" value="<?php echo site_url().'frontend/response2'; ?>">
...
<table class="table table-bordered" style="font-size:12px;line-height: 1.5em;background-color: transparent;">
  ...
  <tr><td width="150">Taxes </td><td class="tdrt">Rs.<?php echo  $taxes;  ?></td></tr>
   ...
   echo date("d-m-Y", strtotime($this->session->userdata('dateofvisit')));  ?></td></tr>
	<tr style="font-weight: bold;font-size: 20px;"><strong><td width="150">Total</td><td class="tdrt">Rs. <?php echo round($this->session->userdata('total'),0);  ?></td></strong></tr>
</table>
                    </div>
                </div>
            </div>
