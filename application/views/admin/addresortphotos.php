							...
							<div class="col-lg-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Update Resort Image</h2>
									</header>
			                            ...
			                            <table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
											...
											<tbody>
												<?php 
													...
													$resortData = $this->db->query("SELECT * FROM tblresorts WHERE resortid='$id'");
												...
												<tr>
													...
													<td><img src="<?php echo base_url().'assets/resortimages/'.$k->bannerimage; ?>" height="80px;"></td>
								
													<td class="center hidden-phone"><a href="#" onclick="deleteresortimages(<?php echo $k->resortid; ?>)">Delete</a></td>
