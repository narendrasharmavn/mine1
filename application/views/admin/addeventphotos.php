					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Upload Event Pics</span></li>
							...
							<div class="col-lg-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Event Images Upload</h2>
									</header>
									<div class="panel-body">
										
										<?php 
								            echo form_open_multipart('Admin/uploadeventpics/'.$eventid,array('class' => 'form-horizontal'));
								        ?>
			                            ...
			                            <h2 class="panel-title">Events Images Data</h2>
			                            <hr>
			                            <div>&nbsp;</div>
			                            <table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
											...
											<tbody>
												<?php 
													...
													$eventData = $this->db->query("SELECT * FROM tbleventphotos WHERE eventid='$eventid'");
													
													foreach ($eventData->result() as $k) {
														# code...
												...
												<tr>
													...
													<td><img src="<?php echo base_url().'assets/eventimages/'.$k->photoname; ?>" height="80px;"></td>
								
													<td class="center hidden-phone"><a href="#" onclick="deleteeventimages(<?php echo $k->photoid; ?>)">Delete</a></td>
	...
	<script type="text/javascript">
        function deleteeventimages(id)
		{
	   	    ...
	   	    if (confirm("Are You Sure You Want To Delete") == true) {
	            ...
	            $.ajax({
			      type: "POST",
			      url: '<?php echo site_url("admin/deleteeventimages")?>',
			      data: {
