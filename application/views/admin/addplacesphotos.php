					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Upload Places Pics</span></li>
							...
							<div class="col-lg-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Places Images Upload</h2>
									</header>
									<div class="panel-body">
								        ...
								        ?>
								         ...
								         ?>
		                                    ...
		                                    <input type="hidden" class="form-control" name="plid" id="plid"  value="<?php echo $placeid; ?>">
			                            ...
			                            <h2 class="panel-title">Places Images Data</h2>
			                            <hr>
			                            <div>&nbsp;</div>
			                            <table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
											...
											<tbody>
												<?php 
													...
													$placeData = $this->db->query("SELECT * FROM tblplacesphotos WHERE plid='$placeid'");
													
													foreach ($placeData->result() as $k) {
														# code...
												...
												<tr>
													...
													<td><img src="<?php echo base_url().'assets/places/'.$k->photoname; ?>" height="80px;"></td>
								
													<td class="center hidden-phone"><a href="#" onclick="deleteplaceimages(<?php echo $k->pphotoid; ?>)">Delete</a></td>
	...
	<script type="text/javascript">
        function deleteplaceimages(id)
		{
	   	    ...
	   	    if (confirm("Are You Sure You Want To Delete") == true) {
	            ...
	            $.ajax({
			      type: "POST",
			      url: '<?php echo site_url("admin/deleteplaceimages")?>',
			      data: {
