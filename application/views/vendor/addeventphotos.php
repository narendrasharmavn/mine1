							...
							<div class="col-lg-12">
								<section class="panel">
									...
									<div class="panel-body">
										...
										<?php 
								            echo form_open_multipart('Vendor/uploadeventpics/'.$eventid,array('class' => 'form-horizontal'));
								        ?>
			                            ...
			                            <table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
											...
											<tbody>
												<?php 
													...
													$eventData = $this->db->query("SELECT * FROM tbleventphotos WHERE photoid='$id'");
												...
												<tr>
													...
													<td class="center hidden-phone"><a href="#" onclick="deleteeventimages(<?php echo $k->rphotoid; ?>)">Delete</a></td>
	...
	<script type="text/javascript">
	    ...
	    function deleteeventimages(id)
		{
	   	    ...
	   	    if (confirm("Are You Sure You Want To Delete") == true) {
	            ...
	            $.ajax({
			      type: "POST",
			      url: '<?php echo site_url("Vendor/deleteeventimages")?>',
			      data: {
