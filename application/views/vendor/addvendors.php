								        ...
								        ?>
								         ...
								         <?php echo $this->session->flashdata('success'); ?> 
											...
											<div class="form-group" style="margin-right: 442px;">
								                ...
								                <div class="col-sm-7">
								                  <input type="number" class="form-control" name="cperson" id="fname" placeholder="Enter contact person name" value="<?php echo set_value('cperson'); ?>">
							                ...
							                <div class="form-group" style="margin-right: 442px;">
								                ...
								                <div class="col-sm-7">
								                  <input type="text" class="form-control" name="pincode" id="fname" placeholder="Enter Pincode" value="<?php echo set_value('pincode'); ?>">
							                ...
							                <div class="form-group" style="margin-right: 442px;">
								                ...
								                <div class="col-sm-7">
								                  <input type="text" class="form-control" name="mobile" id="fname" placeholder="Enter Mobile" value="<?php echo set_value('mobile'); ?>">
