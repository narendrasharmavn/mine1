			...
			<div class="center-sign">
				...
				<div class="panel panel-sign">
					<div class="panel-title-sign mt-xl text-right">
						<h2 class="title text-uppercase text-weight-bold m-none"><i class="fa fa-user mr-xs"></i> OTP </h2>
					</div>
					<div class="panel-body">
					
						<!--Enter OTP -->
						<form name="otp" id="otp" method="post" action="getotp" id="contact" class="well">
							...
							<div class="form-group mb-lg">
								...
								<div class="input-group input-group-icon">
									<input name="otp" type="text" class="form-control input-lg"  />
									<span class="input-group-addon">
										<span class="icon icon-lg">
											<i class="fa fa-user"></i>
										</span>
